...
class _HomePageState extends State<HomePage> {
  ...
  final List coffeeItem = [
    ['lib/images/cappuccino.jpg', 'Cappuccino', 'With fresh milk', '2.25'],
    ['lib/images/latte.jpg', 'Latte', 'With oat milk', '2.30'],
    ['lib/images/americano.jpg', 'Americano', 'on the rock', '1.70'],
  ];
                ...
                child: ListView.builder(
                    ...
                    itemBuilder: (_, index) {
                      return CoffeeTile(
                          ...
                          coffeePrice: coffeeItem[index][3]);
                    }),
              )
            ],
          ),
